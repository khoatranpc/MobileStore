                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            database.getReference().child("User").child(id).child("profileImg").setValue("https://firebasestorage.googleapis.com/v0/b/groceryapp-81ff2.appspot.com/o/man.png?alt=media&token=0bbf1cf9-5f61-472b-ac46-c6b9766520fa");
                            progressBar.setVisibility(View.GONE);
                            startActivity(new Intent(RegistrationActivity.this,LoginActivity.class));
